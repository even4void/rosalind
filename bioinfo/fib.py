...
# finite sequence (π,−2‾√,0,π) and the infinite sequence of odd numbers (1,3,5,
# 7,9,…). We use the notation an to represent the n-th term of a sequence.
...
# millennia ago. When finding the n-th term of a sequence defined by a
# recurrence relation, we can simply use the recurrence relation to generate
# terms for progressively larger values of n. This problem introduces us to the
